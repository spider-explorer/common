...
E = Object.assign(Object.create(E || this), {
  "js":    eval,
  "evaluate":  (...a) => EVAL(a[0], E),
  "js2":  (...a) => { console.log(JSON.stringify(E)); var E=E; return eval(a[0]); },
  //"js2":  (...a) => { console.log(JSON.stringify(E)); var __script__=a[0]; return Function("\"use strict\";return eval(\`" + __script__ + "\`)").bind(E)(); },
