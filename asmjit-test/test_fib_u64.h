#ifndef TEST_FIB_U64_H
#define TEST_FIB_U64_H
...
uint64_t fib_u64(uint64_t n)
{
    ...
    {
        return fib_u64(n - 1) + fib_u64(n - 2);
    }
}

int test_fib_u64(uint64_t n = 8)
{
    ...
    x86::Gp reg_n = cc.argU64(func, 0, "n");
    x86::Gp reg_result = cc.defineU64("result");
    cc.cmp(reg_n, 0);
    ...
    auto reg_n_minus_1 = cc.assignU64(reg_n, "reg_n_minus_1");
    cc.sub(reg_n_minus_1, 1);
    auto reg_n_minus_2 = cc.assignU64(reg_n, "reg_n_minus_2");
    cc.sub(reg_n_minus_2, 2);
    InvokeNode* recNode1;
    cc.invoke(&recNode1,
              func->label(),
              FuncSignatureT<uint64_t, uint64_t>());
